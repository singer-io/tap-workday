...
class TestSync(unittest.TestCase):
    ...
    def test_write_schema_child_selected(self):
        ...
        write_schema(
            mock_stream, client, ["invoice_payments", "invoice_line_items"], catalog
        )
    ...
    @patch("tap_workday.streams.abstracts.IncrementalStream.sync")
    ...
    @patch("singer.write_state")
    def test_remove_currently_syncing(
        self, mock_write_state, mock_set_currently_syncing, mock_get_currently_syncing
    ):
    ...
    @patch("singer.set_currently_syncing")
    @patch("singer.write_state")
    def test_set_currently_syncing(
        self, mock_write_state, mock_set_currently_syncing, mock_get_currently_syncing
    ):
